 ...
 * Description:
 * 
 * This is the TodoSQLite_Android class. It is the second part of the requirements for using a 
 * DependencyService method, which we need to use because somee code needs to be written specific to a platform.
 * Thus, this serves as the android platform's implementation of the ITodoSQLite interface.
 * 
 * */

[assembly: Dependency (typeof (TodoSQLite_Android))]
namespace TTSTest2.Droid
{
    public class TodoSQLite_Android : ITodoSQLite
	{
		public TodoSQLite_Android ()
            //constructor
		{
		}
